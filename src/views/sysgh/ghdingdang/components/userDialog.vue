...
const initFormData = async () => {
  const res = await requestUtil.post("sys/ghdingdang/search_ghs_yg")
...
const handleConfirm = () => {
  if (value.value !== "") {
    requestUtil.post("sys/ghdingdang/updateghs_yg/" + value.value + "/" + ghs_form_value.value+"/"+yg_form_value.value).then(result => {
